//
//  BottomPanModalPresentationAnimator.swift
//  
//
...
public class BottomPanModalPresentationAnimator: NSObject {
    /**
     ...
     */
    private func panModalLayoutType(
        from context: UIViewControllerContextTransitioning
    ) -> BottomPanModalPresentable.LayoutType? {
        switch transitionStyle {
        case .presentation:
            return context.viewController(forKey: .to) as? BottomPanModalPresentable.LayoutType
        case .dismissal:
            return context.viewController(forKey: .from) as? BottomPanModalPresentable.LayoutType
        }
    }
}
...
extension BottomPanModalPresentationAnimator: UIViewControllerAnimatedTransitioning {
    ...
    public func transitionDuration(
        ...
        else { return BottomPanModalAnimator.Constants.defaultTransitionDuration }
