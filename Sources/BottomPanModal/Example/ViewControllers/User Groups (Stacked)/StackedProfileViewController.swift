...
public class StackedProfileViewController: UIViewController, BottomPanModalPresentable {
    ...
    func setupConstraints() {
        ...
        view.safeAreaLayoutGuide.topAnchor.constraint(greaterThanOrEqualTo: roleLabel.bottomAnchor).isActive = true
    }
