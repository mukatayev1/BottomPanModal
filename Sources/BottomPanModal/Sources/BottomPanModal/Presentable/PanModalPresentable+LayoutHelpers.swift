 ...
 */
extension BottomPanModalPresentable where Self: UIViewController {
     ...
     */
    var presentedVC: BottomPanModalPresentationController? {
        return presentationController as? BottomPanModalPresentationController
    }
     ...
     */
    func topMargin(from: BottomPanModalHeight) -> CGFloat {
        switch from {
        case .maxHeight:
            return 0.0
