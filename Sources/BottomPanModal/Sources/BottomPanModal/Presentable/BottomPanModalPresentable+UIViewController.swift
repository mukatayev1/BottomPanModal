//
//  BottomPanModalPresentable+UIViewController.swift
//  
//
...
public extension BottomPanModalPresentable where Self: UIViewController {
     ...
     */
    typealias LayoutType = UIViewController & BottomPanModalPresentable
     ...
     */
    func panModalTransition(to state: BottomPanModalPresentationController.PresentationState) {
