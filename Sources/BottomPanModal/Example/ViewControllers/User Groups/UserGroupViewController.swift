...
public class UserGroupViewController: UITableViewController, BottomPanModalPresentable {
    ...
    public func willTransition(to state: BottomPanModalPresentationController.PresentationState) {
