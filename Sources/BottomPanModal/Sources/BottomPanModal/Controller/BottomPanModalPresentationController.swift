//
//  BottomPanModalPresentationController.swift
//  
//
...
open class BottomPanModalPresentationController: UIPresentationController {
     ...
     */
    private var presentable: BottomPanModalPresentable? {
        return presentedViewController as? BottomPanModalPresentable
    }
     ...
     */
    private lazy var panContainerView: BottomPanContainerView = {
        BottomPanContainerView(
...
public extension BottomPanModalPresentationController {
...
private extension BottomPanModalPresentationController {
    ...
    func configureViewLayout() {
        ...
        guard let layoutPresentable = presentedViewController as? BottomPanModalPresentable.LayoutType
            else { return }
...
extension BottomPanModalPresentationController: UIGestureRecognizerDelegate {
